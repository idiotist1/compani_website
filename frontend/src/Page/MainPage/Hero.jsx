        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <button className="px-8 py-4 bg-white text-blue-600 rounded-lg border-2 border-blue-600 hover:bg-blue-500 transition-colors duration-300 text-lg font-semibold">
                더 알아보기
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4-xl mx-auto">
            {[
              ...
              <div key={index} className="text-center">
                ...
                <div className="text-gray-900">{stat.label}
                </div>
              </div>
            ))
            }
