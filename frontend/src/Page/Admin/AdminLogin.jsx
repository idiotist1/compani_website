        ...
        <form className="mt-8 space-y-6">
          <div className="space-y-4">
            <div className="text-center">
              <label
                htmlFor="username"
                className="text-xl block text-xm font-medium text-gray-700"
              >
                아이디
              </label>
              <input
          ...
          <button type="submit" className="w-full items-center px-4 py-3 border-transparent rounded-lg text-white bg-blue-600 hover:bg-blue-700 font-medium transition-colors duration-300">로그인
