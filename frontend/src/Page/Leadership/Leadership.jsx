...
import Human1 from "../../assets/Human1.jpg"; //이미지를 가져온다.
        ...
        <div className="md:w-1/3">
          <div className="rounded-xl overflow-hidden shadow-lg">
            ...
            <div className="p-4 bg-white">
              ...
              <p className="text-indigo-600 text-center">대표이사</p>
            </div>
          </div>
        </div>
      </div>
          ...
          {executives.map((executive, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-indigo-600 font-semibold mb-4 text-center">
                  {executive.position}
                </p>
